	...
	parse: function( text ) {
		...
		var materialsInfo = {};
			...
			if ( key === "newmtl" ) {
				...
				if ( key === "ka" || key === "kd" || key === "ks" || key === "tf" ) {
		...
		for ( var prop in mat ) {
			...
			switch ( prop.toLowerCase() ) {
				...
				case 'map_kd':
					...
					params[ 'map' ] = THREE.MTLLoader.loadTexture_( this.baseUrl + value );
...
THREE.MTLLoader.loadTexture_ = function ( url, mapping, onLoad, onError ) {
